...
G4VSolid *GeoPtpFactory::ConstructSolid(RAT::DBLinkPtr table) {
  // Inner radius of cylindrical part of Ptp
  G4double r_min = table->GetD("r_min");
  // Outer radius of cylindrical part of Ptp
  G4double r_max = table->GetD("r_max");
  // Half-height of cylindrical part of Ptp
  ...
  G4VSolid *PtpVolumeP1 = new G4UnionSolid("ptp_v1", body, head, *transf);
  ...
  G4UnionSolid *PtpVolume = new G4UnionSolid("ptp", PtpVolumeP1, bot, *neg_transf);
